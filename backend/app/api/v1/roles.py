...
SYSTEM_PERMISSIONS = [
    ...
    # 사용자
    {"code": "user:create", "name": "사용자 생성", "description": "새 사용자를 생성합니다.", "category": "사용자"},
    {"code": "user:read", "name": "사용자 조회", "description": "사용자 목록 및 상세를 조회합니다.", "category": "사용자"},
    {"code": "user:update", "name": "사용자 수정", "description": "사용자 정보를 수정합니다.", "category": "사용자"},
    {"code": "user:delete", "name": "사용자 삭제", "description": "사용자를 비활성화합니다.", "category": "사용자"},
    # 역할
    ...
    {"code": "all", "name": "전체 권한", "description": "모든 기능에 접근할 수 있습니다.", "category": "시스템"},
]
